...
The Jellyfin FFmpeg decoder bundled in the APK is GPL-3.0, consistent with the Orpheus source license (GPL-3.0).
...
| `com.github.teamnewpipe:NewPipeExtractor:v0.26.4` | YouTube search and audio stream extraction | `https://github.com/TeamNewPipe/NewPipeExtractor` | GPLv3 |

## Fork Base

| Project | Role | License |
| --- | --- | --- |
| [PixelPlayerOSS](https://github.com/PixelPlayerHQ/PixelPlayerOSS) | Upstream Android music player fork base | MIT |
