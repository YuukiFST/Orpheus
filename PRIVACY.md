...
Orpheus is local-first and does not include analytics, advertising SDKs, Firebase, Crashlytics, or Google Play Services runtime dependencies.
...
- Orpheus does not submit listening activity to public scrobbling services such as ListenBrainz or Last.fm.

Server credentials and preferences are stored locally. The app does not sell or share user data.

## Files And Media

Orpheus requests media/file permissions to scan and play local music, read artwork, edit metadata, and export/import user backups.
