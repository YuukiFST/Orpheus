...
val enableAbiSplits = providers.gradleProperty("orpheus.enableAbiSplits")
    .getOrElse("true")
    .toBoolean()

val enableComposeCompilerReports = providers.gradleProperty("orpheus.enableComposeCompilerReports")
    .getOrElse("false")
    .toBoolean()

@Suppress("DEPRECATION")
android {
    namespace = "com.yuukifst.orpheus"
    compileSdk = 37
    ...
    defaultConfig {
        applicationId = "com.yuukifst.orpheus"
        minSdk = 30
        targetSdk = 37
