package com.yuukifst.orpheus.data.backup

import android.content.Context
import android.net.Uri
import com.yuukifst.orpheus.data.backup.format.BackupReader
import com.yuukifst.orpheus.data.backup.format.BackupWriter
import com.yuukifst.orpheus.data.backup.history.BackupHistoryRepository
import com.yuukifst.orpheus.data.backup.model.BackupManifest
import com.yuukifst.orpheus.data.backup.model.BackupModuleInfo
...
import com.yuukifst.orpheus.data.backup.model.ModuleRestoreDetail
import com.yuukifst.orpheus.data.backup.model.RestorePlan
import com.yuukifst.orpheus.data.backup.model.ValidationError
...
class BackupManagerTest {
        ...
        every { validationPipeline.validateFile(backupUri) } returns BackupValidationResult.Invalid(
            listOf(
                ValidationError(
                    ...
                    severity = com.yuukifst.orpheus.data.backup.model.Severity.WARNING
                )
            )
        )
    ...
    private fun restorePlan(
        ...
        return RestorePlan(
            ...
            backupUri = "content://orpheus/test-backup",
