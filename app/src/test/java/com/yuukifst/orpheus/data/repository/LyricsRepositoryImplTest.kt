...
import com.yuukifst.orpheus.data.database.LyricsEntity
...
class LyricsRepositoryImplTest {
    ...
    private fun testContext(filesDir: File = Files.createTempDirectory("orpheus-lyrics-test").toFile()): Context {
