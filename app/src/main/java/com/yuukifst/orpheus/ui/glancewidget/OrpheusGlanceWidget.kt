...
import com.yuukifst.orpheus.data.model.QueueItem
import com.yuukifst.orpheus.utils.createScalableBackgroundBitmap
import java.util.Locale
import timber.log.Timber

class OrpheusGlanceWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            ...
            Timber.tag("OrpheusGlanceWidget")
