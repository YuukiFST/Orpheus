...
// Pixel theme — saturated Material-style hues from Settings category pastels
val PixelPrimary = Color(0xFFC2E7FF)
val PixelOnPrimary = Color(0xFF004A77)
val PixelPrimaryContainer = Color(0xFF004A77)
val PixelOnPrimaryContainer = Color(0xFFC2E7FF)
val PixelSecondary = Color(0xFFFFD8E4)
val PixelOnSecondary = Color(0xFF7D5260)
val PixelSecondaryContainer = Color(0xFF7D5260)
val PixelOnSecondaryContainer = Color(0xFFFFD8E4)
val PixelTertiary = Color(0xFFFFDEAC)
val PixelOnTertiary = Color(0xFF6E4E13)
val PixelTertiaryContainer = Color(0xFF6E4E13)
val PixelOnTertiaryContainer = Color(0xFFFFDEAC)
val PixelBackground = Color(0xFF1A1C1E)
val PixelOnBackground = Color(0xFFE2E2E5)
val PixelSurface = Color(0xFF1A1C1E)
val PixelOnSurface = Color(0xFFE2E2E5)
val PixelSurfaceVariant = Color(0xFF44474F)
val PixelOnSurfaceVariant = Color(0xFFC4C6CF)
val PixelOutline = Color(0xFF8E9099)
val PixelOutlineVariant = Color(0xFF44474F)
