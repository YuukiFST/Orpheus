...
class ManifestValidator @Inject constructor() {
     ...
     *
     * Strict by design: both [com.yuukifst.orpheus.data.backup.format.BackupWriter]
     * and [com.yuukifst.orpheus.data.backup.format.LegacyPayloadAdapter] always emit
