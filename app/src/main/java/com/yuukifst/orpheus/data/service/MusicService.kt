...
import com.yuukifst.orpheus.MainActivity
import com.yuukifst.orpheus.R
import com.yuukifst.orpheus.data.model.PlayerInfo
import com.yuukifst.orpheus.data.model.PlaybackQueueItemSnapshot
import com.yuukifst.orpheus.data.model.PlaybackQueueSnapshot
import com.yuukifst.orpheus.data.preferences.EqualizerPreferencesRepository
...
import com.yuukifst.orpheus.data.service.player.TransitionController
import com.yuukifst.orpheus.ui.glancewidget.ControlWidget4x2
import com.yuukifst.orpheus.ui.glancewidget.OrpheusGlanceWidget
import com.yuukifst.orpheus.ui.glancewidget.PlayerActions
import com.yuukifst.orpheus.ui.glancewidget.PlayerInfoStateDefinition
...
import com.yuukifst.orpheus.presentation.viewmodel.ColorSchemeProcessor
import androidx.compose.ui.graphics.toArgb
import com.yuukifst.orpheus.ui.glancewidget.BarWidget4x1
import com.yuukifst.orpheus.ui.glancewidget.GridWidget2x2
...
import com.yuukifst.orpheus.utils.ArtworkTransportSanitizer
import com.yuukifst.orpheus.utils.MediaItemBuilder
import com.yuukifst.orpheus.di.AppScope
import com.yuukifst.orpheus.presentation.viewmodel.ListeningStatsTracker
...
suspend fun loadArtworkBytesViaCoil(context: Context, uri: Uri): ByteArray? {
    ...
    return runCatching {
        ...
        Timber.tag("MusicService_Orpheus").w(error, "Artwork read failed via Coil for uri=%s", uri)
        null
    }
}
...
class MusicService : MediaLibraryService() {
    ...
    companion object {
        ...
        private const val APP_PACKAGE_PREFIX = "com.yuukifst.orpheus"
        private const val LOCAL_LIBRARY_ROOT_ID = "orpheus_root"
    ...
    override fun onCreate() {
        ...
        // through OrpheusMediaButtonReceiver), so the pending counter is only a hint. Promote
    ...
    private fun startTemporaryForegroundForCommand() {
        val notification = NotificationCompat.Builder(
            this,
            OrpheusApplication.NOTIFICATION_CHANNEL_ID
        )
    ...
    private fun getOpenAppPendingIntent(): PendingIntent {
        val intent = Intent(this, MainActivity::class.java).apply {
            ...
            action = "com.yuukifst.orpheus.action.OPEN_PLAYER"
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.yuukifst.orpheus.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.yuukifst.orpheus.data.model.QueueItem(
                            id = songId,
    ...
    public suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.yuukifst.orpheus.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
    ...
    private suspend fun updateGlanceWidgets(playerInfo: PlayerInfo) = withContext(Dispatchers.IO) {
        try {
            ...
            val glanceIds = glanceManager.getGlanceIds(OrpheusGlanceWidget::class.java)
            glanceIds.forEach { id ->
                updateAppWidgetState(applicationContext, PlayerInfoStateDefinition, id) { widgetPlayerInfo }
                OrpheusGlanceWidget().update(applicationContext, id)
            }
