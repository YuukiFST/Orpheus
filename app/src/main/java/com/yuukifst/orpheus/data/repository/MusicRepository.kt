...
interface MusicRepository {
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.yuukifst.orpheus.data.model.SortOption = com.yuukifst.orpheus.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.yuukifst.orpheus.data.model.StorageFilter = com.yuukifst.orpheus.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.yuukifst.orpheus.data.model.SortOption = com.yuukifst.orpheus.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.yuukifst.orpheus.data.model.StorageFilter = com.yuukifst.orpheus.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.yuukifst.orpheus.data.model.SortOption = com.yuukifst.orpheus.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.yuukifst.orpheus.data.model.StorageFilter = com.yuukifst.orpheus.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.yuukifst.orpheus.data.model.SortOption = com.yuukifst.orpheus.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.yuukifst.orpheus.data.model.StorageFilter = com.yuukifst.orpheus.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.yuukifst.orpheus.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.yuukifst.orpheus.data.model.StorageFilter = com.yuukifst.orpheus.data.model.StorageFilter.ALL
    ): Flow<List<com.yuukifst.orpheus.data.model.MusicFolder>>
