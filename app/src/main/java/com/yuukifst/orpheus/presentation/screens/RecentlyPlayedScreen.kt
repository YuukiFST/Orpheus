...
import com.yuukifst.orpheus.presentation.components.RecentlyPlayedRangeSelector
...
import com.yuukifst.orpheus.presentation.model.RecentlyPlayedSongUiModel
            ...
            LazyColumn(
                ...
                if (recentlyPlayedSongs.isEmpty()) {
                    ...
                    groupedSongs.forEachIndexed { groupIndex, group ->
                        ...
                        itemsIndexed(group.songs, key = { _, songUi -> songUi.song.id }, contentType = { _, _ -> "recently_played_song" }) { songIndex, item ->
