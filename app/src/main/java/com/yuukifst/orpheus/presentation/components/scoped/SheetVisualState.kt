...
internal fun rememberSheetVisualState(
    ...
    val baseBottomPadding = remember(containerHeight, sheetCollapsedTargetY, density) {
        ...
        (containerHeight - com.yuukifst.orpheus.presentation.components.MiniPlayerHeight - targetYDp)
            .coerceAtLeast(0.dp)
    }

    val currentBottomPadding = 0.dp

    val miniHeightPx = remember(density) { with(density) { com.yuukifst.orpheus.presentation.components.MiniPlayerHeight.toPx() } }
