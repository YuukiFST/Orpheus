...
import com.yuukifst.orpheus.data.database.AlbumArtThemeEntity
import com.yuukifst.orpheus.data.database.StoredColorSchemeValues
import com.yuukifst.orpheus.data.database.toComposeColor
import com.yuukifst.orpheus.utils.LocalArtworkUri
import com.yuukifst.orpheus.utils.traceAsyncSection
import com.yuukifst.orpheus.ui.theme.clearExtractedColorCache
import com.yuukifst.orpheus.ui.theme.extractSeedColor
import com.yuukifst.orpheus.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.yuukifst.orpheus.ui.theme.ColorExtractionConfig(
