...
import com.yuukifst.orpheus.data.media.ImageCacheManager
import com.yuukifst.orpheus.data.media.MetadataEditError
...
import com.yuukifst.orpheus.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.yuukifst.orpheus.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
