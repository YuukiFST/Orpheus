...
class MusicDaoTest {
    ...
    private lateinit var db: OrpheusDatabase

    @Before
    fun createDb() {
        val context = ApplicationProvider.getApplicationContext<Context>()
        db = Room.inMemoryDatabaseBuilder(context, OrpheusDatabase::class.java)
    ...
    private suspend fun seedReferentialParents() {
    ...
    fun insertMusicData_clearsOldAndInsertsNew() = runTest {
        ...
        assertNotNull(musicDao.getSongById(1L).first())
        assertNotNull(musicDao.getSongById(10L).first())
    }
